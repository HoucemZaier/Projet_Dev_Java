...
public class UserManagementController implements Initializable {
    ...
    private void handleTransportPublique(ActionEvent event) {
        ...
        navigateTo("/ui/transport/affichierpublique.fxml", "Transport Publique Management");
    }

    @FXML
    private void handleTransportPrivee(ActionEvent event) {
        // Navigate to Transport Privée management
        navigateTo("/ui/transport/affichierprive.fxml", "Transport Privée Management");
    }
    ...
    private void handleHotels(ActionEvent event) {
        try {
            ...
            if (controller != null) {
                ...
                controller.handleHotels(null); // Load hotels immediately after navigation
            }

            Stage stage = (Stage) userContainer.getScene().getWindow();
            stage.setScene(new Scene(root));
            stage.setTitle("PlaNova - Gestion des Hôtels");
            stage.show();
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    @FXML
    private void handleChambres(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/dashboard/dashboard.fxml"));
            Parent root = loader.load();
            ...
            if (controller != null) {
                controller.setCurrentUser(currentUser);
                controller.handleChambres(null); // Load chambers immediately after navigation
            }

            Stage stage = (Stage) userContainer.getScene().getWindow();
            stage.setScene(new Scene(root));
            stage.setTitle("PlaNova - Gestion des Chambres");
            stage.show();
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void handleDashbordManagement(ActionEvent event) {
        ...
        navigateTo("/ui/dashboard/dashboard.fxml", "User Management");
    }
    ...
    private void navigateTo(String fxmlFile, String title) {
        try {
            ...
            // If navigating to dashboard, set the user context
            if (fxmlFile.equals("/ui/dashboard/dashboard.fxml")) {
                dashboardController controller = loader.getController();
            ...
            showAlert(Alert.AlertType.ERROR, "Erreur de Navigation",
                    "Échec de la navigation vers " + title + ": " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private HBox createUserCard(User user) {
        ...
        card.setStyle(
                "-fx-background-color: white; -fx-padding: 15; -fx-background-radius: 8; -fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.1), 5, 0, 0, 2); -fx-cursor: hand;");
        ...
        statusLabel.setStyle(
                "-fx-font-size: 11px; -fx-font-weight: bold; -fx-padding: 3 8 3 8; -fx-background-radius: 10;");
        if (user.isBlocked()) {
        ...
        roleLabel.setStyle(
                "-fx-font-size: 12px; -fx-font-weight: bold; -fx-padding: 5 10 5 10; -fx-background-radius: 12;");
        ...
        // Action buttons (Edit, Block/Unblock, and Delete) - beautiful icon-only
        // buttons
    ...
    private void selectCard(HBox card, User user) {
        ...
        card.setStyle(
                "-fx-background-color: #ecf0f1; -fx-padding: 15; -fx-background-radius: 8; -fx-border-color: #3498db; -fx-border-width: 2; -fx-effect: dropshadow(three-pass-box, rgba(52,152,219,0.3), 5, 0, 0, 2); -fx-cursor: hand;");
    ...
    private void openModifyUserWindow(User user) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/user/modifyuser.fxml"));
            Parent root = loader.load();
            ...
            showAlert(Alert.AlertType.ERROR, "Erreur",
                    "Échec de l'ouverture de la fenêtre de modification utilisateur: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private void openDeleteConfirmation(User user) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/user/deleteconfirmation.fxml"));
            Parent root = loader.load();
            ...
            showAlert(Alert.AlertType.ERROR, "Erreur",
                    "Échec de l'ouverture de la confirmation de suppression: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    private void showUserInfo(User user) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/user/userinfo.fxml"));
            Parent root = loader.load();
            ...
            showAlert(Alert.AlertType.ERROR, "Erreur",
                    "Échec de l'ouverture des informations utilisateur: " + e.getMessage());
            e.printStackTrace();
        }
    }
        ...
        try {
            ...
            if (users == null) {
                ...
                showAlert(Alert.AlertType.WARNING, "Avertissement",
                        "Échec de la récupération des utilisateurs: le service a renvoyé null");
                return;
            }
            ...
            showAlert(Alert.AlertType.ERROR, "Erreur de Base de Données",
                    "Échec du chargement des utilisateurs: " + e.getMessage());
        } catch (Exception e) {
            showAlert(Alert.AlertType.ERROR, "Erreur",
                    "Erreur inattendue lors du chargement des utilisateurs: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public void addNewUser(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/user/adduser.fxml"));
            Parent root = loader.load();
            ...
            showAlert(Alert.AlertType.ERROR, "Erreur",
                    "Échec de l'ouverture de la fenêtre d'ajout d'utilisateur: " + e.getMessage());
        }
    }
    ...
    private void navigateToDashboard() {
        try {
            ...
            showAlert(Alert.AlertType.ERROR, "Erreur de Navigation",
                    "Échec de la navigation vers le tableau de bord: " + e.getMessage());
        }
    }
