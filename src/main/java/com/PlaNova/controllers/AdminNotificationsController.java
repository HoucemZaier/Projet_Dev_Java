...
import com.PlaNova.services.FileUploadService;
...
public class AdminNotificationsController implements Initializable {
    ...
    private void rejectApplication(String clientEmail, String clientName, VBox card) {
        try {
            ...
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("/ui/user/rejectguidedialog.fxml"));
    ...
    private void convertClientToGuide(String clientEmail) throws Exception {
        ...
        if (client != null) {
            ...
            com.PlaNova.models.Guide newGuide = new com.PlaNova.models.Guide(
                client.getNom(),
                client.getPrenom(),
                client.getEmail(),
