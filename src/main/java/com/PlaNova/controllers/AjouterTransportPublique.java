...
public class AjouterTransportPublique implements Initializable {
        ...
        try {
            ...
            if (!isValidHoraire(horaire)) {
                showAlert(Alert.AlertType.ERROR, "Erreur",
                        "L'horaire doit respecter le format HH:mm - HH:mm et être logique.");
                return;
            }
            ...
            if (destination == null) {
                showAlert(Alert.AlertType.ERROR, "Erreur", "Veuillez sélectionner une destination.");
                return;
            }
            ...
            // Création de l'objet TransportPublique en utilisant le constructeur par défaut
            // + setters
            ...
            transport.setId_destination(destination.getId_destination());
    ...
    public void initialize(URL location, ResourceBundle resources) {
        // Si le ComboBox est lié via FXML, on le peuple avec quelques valeurs par
        // défaut
