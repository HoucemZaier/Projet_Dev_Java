...
import com.PlaNova.services.QRCodeService;
...
public class listChambreController implements Initializable {
    ...
    private void handleAjouterChambre() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/hotel/ajouterchambre.fxml"));
    ...
    private void handleModifierChambre(Chambre chambre) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/hotel/modifierchambre.fxml"));
            Parent root = loader.load();
    ...
    private void handleVoirDetails(Chambre chambre) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/hotel/detailschambre.fxml"));
            Parent root = loader.load();
