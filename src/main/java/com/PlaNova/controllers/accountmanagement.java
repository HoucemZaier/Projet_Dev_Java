...
import com.PlaNova.services.NotificationService;
...
public class accountmanagement implements Initializable {
    ...
    private void handleSaveChanges(ActionEvent event) {
        ...
        if ((currentUser instanceof com.PlaNova.models.Admin || currentUser instanceof com.PlaNova.models.Moderateur)
    ...
    private void handleBecomeGuide(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/user/guiderequirements.fxml"));
    ...
    private void handleSetup2FA(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/user/twofactorsetup.fxml"));
            Parent root = loader.load();
