...
import com.PlaNova.services.SocialAuthService;
...
public class  loginController {
    ...
    private void handleSignup(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/create.fxml"));
    ...
    private void show2FAVerification(User user) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/ui/user/twofactorverification.fxml"));
            Parent root = loader.load();
