...
public class Hotel {
    ...
    public Hotel(int idHotel, String nomHotel, String adresse, String ville, int nombreEtoile, String description, String image, int idDestination) {
    ...
    public String toString() {
        return nomHotel + " (" + nombreEtoile + " Stars)";
    }
}
