...
public class UserSession {
    ...
    public boolean isAdmin() {
        return currentUser != null && currentUser instanceof com.PlaNova.models.Admin;
    }

    public boolean isModerator() {
        return currentUser != null && currentUser instanceof com.PlaNova.models.Moderateur;
    }

    public boolean isGuide() {
        return currentUser != null && currentUser instanceof com.PlaNova.models.Guide;
    }

    public boolean isClient() {
        return currentUser != null && currentUser instanceof com.PlaNova.models.Client;
    }
