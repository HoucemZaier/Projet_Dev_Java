...
public class ajouterHotelController {
    ...
    @FXML private Label nomHotelError;
    ...
    @FXML private Label etoilesError;
    ...
    private void handleAjouterHotel() {
        ...
        if (nomHotelError.isVisible() || villeError.isVisible() || adresseError.isVisible() ||
                etoilesError.isVisible() || descriptionError.isVisible()) {
    ...
    private void showFieldError(Control field, Label errorLabel, String message) {
        field.setStyle("-fx-border-color: #dc2626; -fx-border-width: 1.5; -fx-border-radius: 10; -fx-background-radius: 10;");
