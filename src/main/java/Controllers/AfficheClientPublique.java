...
public class AfficheClientPublique implements Initializable {
    ...
    private void setupEventHandlers() {
        ...
        if (btnItineraire != null) {
            ...
            btnItineraire.setOnAction(e -> openItineraireDialog());
    ...
    private void openItineraireDialog() {

        try {

            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("/ItineraireDialog.fxml"));
            ...
            stage.setTitle("🗺️ Calcul d'Itinéraire - PlaNova Transport");
            ...
            showAlert("Erreur", "Impossible d'ouvrir la fenêtre d'itinéraire: " + e.getMessage());
