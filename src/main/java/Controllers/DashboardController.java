...
public class DashboardController {
    ...
    @FXML
    private void onActiviteClicked(ActionEvent event) {
        loadView("/ListActivite.fxml");
    }

    @FXML
    private void onExcursionClicked(ActionEvent event) {
        loadView("/listExcursion.fxml");
    }
